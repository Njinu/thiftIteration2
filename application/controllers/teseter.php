        ...
        <div class="container">
          <div class="row space-top">
            ...
            <div class="col-sm-8 space-bottom">
              ...
              <div class="row">
                <?php echo form_open('user/edititem',array('id'=>'frm2','class'=>'col-md-12 personal-info')) ?>
                  <div class="row">
                    <div class="form-group col-sm-6">
                      <label for="api_first_name">First name</label>
                      <input type="text" class="form-control" name="api_first_name" id="api_first_name" placeholder="First name" value='<?php echo $me['firstname']; ?>' required>
                    </div>
                    <div class="form-group col-sm-6">
                      <label for="api_last_name">Last name</label>
                      <input type="text" class="form-control" name="api_last_name" id="api_last_name" placeholder="Last name" value='<?php echo $me['lastname']; ?>' required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-sm-6">
                      <label for="api_email">Email</label>
                      <input type="email" class="form-control" name="api_email" id="api_email" placeholder="Email" value='<?php echo $me['email']; ?>' required>
                    </div>
                    <div class="form-group col-sm-6">
                      <label for="api_phone">Phone</label>
                      <input type="text" class="form-control" name="api_phone" id="api_phone" placeholder="Phone" value='<?php echo $me['phone']; ?>' required>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="form-group col-sm-6">
                      ...
                      <input type="password" class="form-control" name="api_password" id="api_password" placeholder="Current Password" required>
                    </div>
                    <div class="form-group col-sm-6">
                      <label for="api_conf_password">New password</label>
                      <input type="password" class="form-control" name="api_conf_password" id="api_conf_password" placeholder="New password" required>
                    </div>
                    <div class="form-group col-sm-6">
                      <label for="api_conf_password">Confirm New password</label>
                      <input type="password" class="form-control" name="api_conf_password" id="api_conf_password" placeholder="Confirm New password" required>
                    </div>               
                  </div>

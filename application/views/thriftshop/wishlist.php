     ...
     <div class="row">
       ...
       <div class="col-lg-9 col-md-9">
         ...
         <table class="items-list">
          ...
          <tr class="item first">
            <td class="thumb"><a href='<?php echo base_url()."index.php/". "thriftshop/view/".$filter["slug"]."/".$filter['product_id']?>'><img style="max-height:152px;min-height:119px" src='<?php echo base_url();?>uploads/<?php echo $filter['pic_id'] ?>' alt="1"/></a></td>

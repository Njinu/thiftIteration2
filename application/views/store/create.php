...
<h2 class="articlehead" style="margin-top:2%;margin-bottom:2%;">Create a product</h2>
...
<?php echo form_open('store/create') ?>



	

	<input class="form-control" placeholder="Enter Name" type="input" name="name" /><br />



	

	<input class="form-control" placeholder="Enter Price" type="number" name="price" /><br />





	<input class="form-control" placeholder="Enter Category" type="input" name="category" /><br />





	<input class="form-control" placeholder="Enter Vibe" type="input" name="vibe" /><br />



	

	<textarea class="form-control" rows="8" placeholder="Enter Description" name="description"></textarea><br />

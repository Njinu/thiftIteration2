...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js" type="text/javascript" charset="utf-8"></script>
	...
	<?php 
			...
			$displayedproduct = reset($productarray);

		$itemvibe =  $displayedproduct['vibe'];
	 ...
	 if($itemvibe == 'Love')
 		...
 		?>
            ...
            <div class="ui-progress" style="width: 79%;">
                <span class="ui-label " style="display:none; font-size: 62.5%;
  font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">Processing <b class="value">79%</b></span>
            </div><!-- .ui-progress -->
        </div><!-- #progress_bar -->
	                         <img src='<?php echo base_url()."/assets/ThriftshopTheme/img/ThriftShopcover.png"?>'>
	                           <div class="caption">
	                             <h3 style="color:white"><?php echo $displayedproduct['name'] ?></h3>
	                             <hr>
	                              <p style="color:white; font-size:110%;" class=""><?php echo $quote ?></p>
	                              <p><a href="<?php echo base_url()."index.php/store/". $displayedproduct['slug'] ?>" class="btn btn-info" role="button">View Item</a></p>
	                             </div> 
	                        </div>
	                    </div>	    
	            </div>
